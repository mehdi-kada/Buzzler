...
Revision ID: 1f1d8b1cc2c2
Revises: 
Create Date: 2025-08-17 21:13:00.407357
...
def upgrade() -> None:
    ...
    op.create_index('idx_file_cleanup', 'file_storages', ['is_temporary', 'expires_at'], unique=False)
    op.create_index('idx_file_entity', 'file_storages', ['entity_type', 'entity_id'], unique=False)
    op.create_index('idx_file_storage_stats', 'file_storages', ['storage_provider', 'file_type', 'created_at'], unique=False)
    op.create_index(op.f('ix_file_storages_entity_id'), 'file_storages', ['entity_id'], unique=False)
    op.create_index(op.f('ix_file_storages_entity_type'), 'file_storages', ['entity_type'], unique=False)
    op.create_index(op.f('ix_file_storages_expires_at'), 'file_storages', ['expires_at'], unique=False)
    op.create_index(op.f('ix_file_storages_file_type'), 'file_storages', ['file_type'], unique=False)
    op.create_index(op.f('ix_file_storages_is_deleted'), 'file_storages', ['is_deleted'], unique=False)
    op.create_index(op.f('ix_file_storages_is_temporary'), 'file_storages', ['is_temporary'], unique=False)
    ...
    sa.Column('account_lockout_expiry', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('azure_file_path', sa.String(length=512), nullable=True),
    sa.Column('azure_video_url', sa.Text(), nullable=True),
    sa.Column('azure_audio_url', sa.Text(), nullable=True),
    sa.Column('upload_url', sa.Text(), nullable=True),
    sa.Column('upload_expires_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('status', sa.Enum('uploading', 'uploaded', 'transcribing', 'analyzing', 'ready', 'failed', 'pending_upload', name='videostatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('azure_file_path')
    )
    op.create_index('idx_videos_status_created', 'video', ['status', 'created_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_videos_status_created', table_name='video')
    op.drop_table('video')
    ...
    op.drop_table('user')
    op.drop_index(op.f('ix_file_storages_is_temporary'), table_name='file_storages')
    op.drop_index(op.f('ix_file_storages_is_deleted'), table_name='file_storages')
    op.drop_index(op.f('ix_file_storages_file_type'), table_name='file_storages')
    op.drop_index(op.f('ix_file_storages_expires_at'), table_name='file_storages')
    op.drop_index(op.f('ix_file_storages_entity_type'), table_name='file_storages')
    op.drop_index(op.f('ix_file_storages_entity_id'), table_name='file_storages')
    op.drop_index('idx_file_storage_stats', table_name='file_storages')
    op.drop_index('idx_file_entity', table_name='file_storages')
    op.drop_index('idx_file_cleanup', table_name='file_storages')

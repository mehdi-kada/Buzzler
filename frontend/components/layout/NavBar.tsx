    ...
    <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
                <Link href="#" className="nav-link text-white font-medium">Dashboard</Link>
                <Link href="#" className="nav-link text-gray-300 font-medium">Projects</Link>
                <Link href="#" className="nav-link text-gray-300 font-medium">Analytics</Link>
                <Link href="#" className="nav-link text-gray-300 font-medium">Settings</Link>
            </div>
